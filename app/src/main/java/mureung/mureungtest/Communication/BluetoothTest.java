...
public class BluetoothTest extends Service {
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onConnectionStateChange(BluetoothGatt gatt, int status,
            ...
            if (newState == BluetoothProfile.STATE_CONNECTED) {
                ...
                broadcastUpdate(MainActivity.mainContext,intentAction);
        ...
        public void onReadRemoteRssi(BluetoothGatt gatt, int rssi, int status) {
            if (status == BluetoothGatt.GATT_SUCCESS) {
                broadcastUpdate(MainActivity.mainContext,ACTION_GATT_RSSI, rssi);
            } else {
        ...
        public void onServicesDiscovered(BluetoothGatt gatt, int status) {
            if (status == BluetoothGatt.GATT_SUCCESS) {
                broadcastUpdate(MainActivity.mainContext,ACTION_GATT_SERVICES_DISCOVERED);
            } else {
    ...
    private void broadcastUpdate(Context context, final String action) {
        final Intent intent = new Intent(action);
        context.sendBroadcast(intent);
    }

    private void broadcastUpdate(Context context,final String action, int rssi) {
        final Intent intent = new Intent(action);
    ...
    public class LocalBinder extends Binder {
        public BluetoothTest getService() {
            return BluetoothTest.this;
        }
    }
    ...
    public boolean connect(final String address) {
        Dlog.e("test BluetoothAdapter : " + mBluetoothAdapter + " , address : " + address);
